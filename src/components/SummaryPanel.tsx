        ...
        <div className={styles.panel}>
            <section className={styles.fault}>
                ...
                <dl className={styles.faultDetails}>
                    {exception.subtype && <Detail label="Subtype" value={exception.subtype} />}
                    {exception.codes && <Detail label="Codes" value={exception.codes} mono />}
                </dl>
                            ...
                            <li key={frame.depth} className={styles.peekFrame}>
                                ...
                                <span className={styles.peekSymbol}>
                                    ...
                                    {frame.symbolOffset !== undefined && (
                                        <span className={styles.peekOffset}>
                                            {' '}
                                            + {frame.symbolOffset}
                                        </span>
                                    )}
